...
public interface GetRecommendationsFromClovaSwagger {
    ...
    ResponseEntity<RestResponse<List<ClovaRecommendationResponse>>> requestRecommendations(@Parameter(hidden = true) Member member, AIRecommendationRequest aiRecommendationRequest);
}
